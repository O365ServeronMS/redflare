...
//             and reported honestly, but something (OPhim fully down,
...
async function handleApi(request, env, ctx, url) {
  ...
  try {
    ...
    // repeatedly doesn't redo the OPhim round-trip every time.
    ...
    if (stale != null) {
      ...
      // doomed OPhim/TMDB round-trip. 60s so it drops the stale copy quickly
